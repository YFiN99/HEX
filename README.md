...
Live app: **https://hex-amm.vercel.app**
...
- **Smart** — AI-assisted on-chain tools powered by [GenLayer](https://genlayer.com) Intelligent Contracts:
  - **Justice Audit** — scans and audits target contracts/sources on-chain.
  - **Post (Airdrop Investigator)** — investigates a URL and generates intelligence analysis.
  - **Ask Global AI** — general-purpose on-chain AI Q&A and conversation history on-chain.
