        ...
        <main className="transparency-page">
            ...
            <section className="transparency-header">
                ...
                <p className="transparency-lead">
                    <strong>HEX upholds the principles of FAIRNESS and
            ...
            {/* =====================================================
                1. SPOT SETTLEMENT & FAIR TRADING
            ===================================================== */}
            ...
            <section className="transparency-section">
                ...
                <div className="section-content">
                    <h2>Spot Settlement &amp; Fair Trading</h2>
                    ...
                    <p>
                        <strong>HEXRouter prioritizes fairness for all users</strong>,
                ...
                <div className="section-content">
                    ...
                    <div className="fee-breakdown">
                        ...
                        <div className="fee-row">
                            ...
                            <div className="fee-description">
                                <strong>Pool</strong>
                                <span>→ remains part of the pool</span>
                            </div>
                        </div>
                    ...
                    <p>
                        The fee distribution can be verified according to
                        the protocol's on-chain mechanism.
                    </p>
                </div>
            </section>
            ...
            <section className="transparency-section">
                ...
                <div className="section-content">
                    ...
                    <div className="disclaimer-box">
                        ...
                        <h3>Trading Disclaimer</h3>

                        <p>
                            This page explains the mechanisms of HEX and
                            its principles of transparent trading.
                        </p>

                        <p>
                            Users are responsible for understanding the
                            mechanisms, fees, risks, and transaction terms
                            before performing a swap or providing liquidity.
                        </p>
